...
A new Hermes candidate was intentionally not built. The supported Python 3.12 suite is complete at 573 collected, 573 passed, 0 failed, and 0 skipped, but the real Hermes provider request returned HTTP 429 before producing a valid structured plan. The required Hermes pilots therefore have not all passed.
