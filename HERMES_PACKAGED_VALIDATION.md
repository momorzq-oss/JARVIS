...
A new Hermes candidate was intentionally not built. The supported Python 3.12 suite is complete at 595 collected, 595 passed, 0 failed, and 0 skipped. One real zero-tool response failed exact-schema validation and three later exact-schema requests returned HTTP 429, so the required Hermes pilots have not all passed.
