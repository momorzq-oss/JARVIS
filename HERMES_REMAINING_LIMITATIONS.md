...
3. Hermes is installed and diagnostics pass. One live zero-tool response was rejected for violating the exact response schema; the exact-schema retry was rate-limited by provider Groq (HTTP 429). No structured plan has been accepted.
