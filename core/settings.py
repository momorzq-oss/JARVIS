...
DEFAULTS = {
    ...
    "silence_reminder_seconds": 15.0,
    "second_silence_reminder_seconds": 30.0,
    "conversation_inactivity_timeout_seconds": 60.0,
    "silence_detection_seconds": 1.4,
    "speech_start_threshold": 3.0,
    "minimum_speech_seconds": 0.35,
    "maximum_recording_seconds": 30.0,
    "post_speech_listening_delay_seconds": 0.35,
    "background_noise_threshold": 0.015,
    "conversation_response_length": "concise",
    "conversation_memory_limit": 20.0,
    "return_to_wake_after_inactivity": True,
    ...
    "microphone_sensitivity": 1.0,
    "echo_suppression_enabled": True,
    "background_noise_filtering_enabled": True,
